...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MatchPanel = React.createClass({
	  ...
	  render: function () {
	    React.createElement(
	      'div',
	      { 'class': 'row profile match-panel table-responsive' },
	      React.createElement(
	        'div',
	        { 'class': 'row profile-sidebar' },
	        React.createElement(
	          'div',
	          { 'class': 'text-center col-md-2 profile-usertitle-time' },
	          'DD/MM/YYYY'
	        ),
	        React.createElement(
	          'div',
	          { 'class': 'profile-userpic col-md-2' },
	          React.createElement('img', { src: '{% static \'img/MfIcon.png\' %}', 'class': 'img-responsive', alt: '' })
	        ),
	        React.createElement(
	          'div',
	          { 'class': 'col-md-3 profile-usertitle' },
	          React.createElement(
	            'div',
	          ...
	          React.createElement(
	            'div',
	            { 'class': 'profile-usertitle-kda' },
	            '15/0/1'
	          )
	        ),
	        React.createElement(
	          'div',
	          { 'class': 'profile-summ-spells col-md-2' },
	          React.createElement('img', { 'class': 'spell', src: '{% static \'img/flash-icon.jpg\' %}', 'class': 'img-responsive', alt: '' }),
	          React.createElement('img', { 'class': 'spell', src: '{% static \'img/flash-icon.jpg\' %}', 'class': 'img-responsive', alt: '' })
	        ),
	        React.createElement(
	          'div',
	          { 'class': 'rune-rating col-md-3' },
	          'Hi! I am Radar'
	        )
	      ),
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'table',
	            { 'class': 'rune-panel player-runes text-center' },
	            React.createElement(
	              'thead',
	              { 'class': 'tree-icon text-center' },
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'table',
	            { 'class': 'rune-panel player-runes text-center secondary-tree' },
	            React.createElement(
	              'thead',
	              { 'class': 'tree-icon text-center' },
	              React.createElement('th', null),
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'table',
	            { 'class': 'rune-panel rune-description' },
	            React.createElement(
	              'thead',
	              null,
	              React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'table',
	            { 'class': 'rune-panel optimal-runes text-center' },
	            React.createElement(
	              'thead',
	              { 'class': 'tree-icon text-center' },
	              React.createElement('th', null),
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'table',
	            { 'class': 'rune-panel optimal-runes text-center secondary-tree' },
	            React.createElement(
	              'thead',
	              { 'class': 'tree-icon text-center' },
	              React.createElement('th', null),
